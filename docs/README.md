...
cp /path/to/your/app-release.apk ./docs/splashline.apk
```
...
This directory is configured for GitHub Pages deployment. Once pushed to GitHub:
...
Your site will be available at: `https://Tendaimurambidzi.github.io/AqualinkTindoe/`
