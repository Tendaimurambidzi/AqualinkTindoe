...
var tokenize = function (input) {
    ...
    if (!text)
        return [{ type: 'text', content: '', key: 'empty' }];
    var tokens = [];
    var lastIndex = 0;
    var match;
    while ((match = TOKEN_REGEX.exec(text)) !== null) {
        var start = match.index;
        var end = TOKEN_REGEX.lastIndex;
        if (start > lastIndex) {
            tokens.push({
                type: 'text',
                content: text.slice(lastIndex, start),
                key: "t-".concat(lastIndex),
            });
        }
        var value = match[0];
        tokens.push({
    ...
    var openExternal = function (url) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    err_1 = _a.sent();
                    console.log('Failed to open URL:', err_1);
                    return [3 /*break*/, 5];
...
exports.default = ClickableTextWithLinks;
