...
function DataSaverProvider(_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        json = _b.sent();
                        if (json) {
                            saved_1 = JSON.parse(json);
                            setStateRaw(function (s) { return (__assign(__assign({}, s), saved_1)); });
                        }
                        return [3 /*break*/, 3];
                    case 2:
                        _a = _b.sent();
    ...
    (0, react_1.useEffect)(function () {
        async_storage_1.default.setItem(KEY, JSON.stringify({
    ...
    (0, react_1.useEffect)(function () {
        var sub = netinfo_1.default.addEventListener(function (info) {
            var cellular = info.type === 'cellular';
            setStateRaw(function (s) { return (__assign(__assign({}, s), { cellular: cellular })); });
        });
        return function () { return sub && sub(); };
    }, []);
    var setState = function (patch) { return setStateRaw(function (s) { return (__assign(__assign({}, s), patch)); }); };
    var value = (0, react_1.useMemo)(function () { return (__assign(__assign({}, state), { setState: setState })); }, [state]);
